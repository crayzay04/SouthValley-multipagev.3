    ...
    <footer className="bg-black text-white border-t border-gray-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="md:col-span-1">
            ...
            <div className="flex gap-4 mt-4">
              <a href="#" onClick={(e) => e.preventDefault()} aria-label="Instagram" className="text-gray-400 hover:text-[#0057B8] transition-colors">
              ...
              <a href="#" onClick={(e) => e.preventDefault()} aria-label="Facebook" className="text-gray-400 hover:text-[#0057B8] transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mt-12 pt-6 border-t border-gray-800 flex flex-col sm:flex-row items-center justify-between gap-3 text-gray-500 text-xs">
          <p>© 2025 South Valley Surf Soccer Club | All Rights Reserved</p>
